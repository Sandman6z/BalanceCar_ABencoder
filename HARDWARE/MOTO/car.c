...
#define SetPointR SetPoint*6240/600//换算成编码器速度，因为最终pid控制的是编码器的脉冲数量
...
//			OLED_ShowNum(56,1,temp,4,12);    //减速箱输出目标值
		  ...
		  //OLED_ShowNum(70,6,Encoder_Right,4,16);    //右轮减速箱输出值
			...
			OLED_ShowNum(70,4,temp1,3,16);    //左实际减速箱输出转速 单位RMP
			temp2 = Encoder_Right*600/6240;
			OLED_ShowNum(70,6,temp2,3,16);    //右实际减速箱输出转速 单位RPM
			//车速
